...
if(window.config.theme.titleFontColor != "")$('.login-header').css('color',window.config.theme.titleFontColor);
if(window.config.theme.backgroundColor != "")$('.login-form').css('background',window.config.theme.formColor);
if(window.config.theme.formFontColor != "")$('.login-form').css('color',window.config.theme.formFontColor);
